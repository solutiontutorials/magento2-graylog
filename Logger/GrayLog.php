...
namespace Solutiontutorials\Graylog\Logger;
...
class GrayLog implements LoggerInterface
{
    ...
    protected function getHandler(){
        if(!$this->_handler){
            /**
             * @var $loggerBuilder \Solutiontutorials\Graylog\Logger\GrayLog\LoggerBuilder
             */
            $loggerBuilder = $this->objectManager->get(\Solutiontutorials\Graylog\Logger\GrayLog\LoggerBuilder::class);
